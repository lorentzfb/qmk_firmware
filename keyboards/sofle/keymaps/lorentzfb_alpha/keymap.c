...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    LT(_NUM, KC_V),    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
        XXXXXXX, KC_LCTL, LT(_RAISE, KC_BSPC), KC_SPC, XXXXXXX,          XXXXXXX, KC_ENT, LT(_LOWER,KC_MINUS), KC_RCTL,XXXXXXX
),
...
[_LOWER] = LAYOUT(
  ...
  _______,  KC_BSLS,  KC_SLSH,  KC_ASTR, KC_FATARR, KC_HASH, _______,    _______, KC_TILD,   KC_DLR,  KC_LCBR,  KC_RCBR,      KC_AT, _______,
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  | LAt  | LCtl |LShift|      | Caps |-------.    ,-------| Left | Down |  Up  | Rigth|      |      |
 * |------+------+------+------+------+------|  MUTE  |    |       |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT(
  ...
  _______, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), XXXXXXX,  _______,       _______,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
                         _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
),
...
[_NUM] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, MO(_ADJUST), XXXXXXX, XXXXXXX,                   KC_MINS, KC_P4,  KC_P5,   KC_P6,   KC_PLUS,  KC_PIPE,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,_______,   _______,  KC_P0,  KC_P1,  KC_P2,   KC_P3,   KC_SLSH, _______,
              _______, _______, _______, _______, _______,             KC_EQL, KC_DOT, _______, _______, _______
),
